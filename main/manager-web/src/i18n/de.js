export default {
  ...
  'roleConfig.memmeDataHint': 'Kontoweites Gedaechtnis; nur gefilterter Text',
  'roleConfig.exportMemMeData': 'Kontogedaechtnis exportieren',
  'roleConfig.deleteAllMemMeData': 'Kontogedaechtnis leeren',
  'roleConfig.exportMemMeSuccess': 'Langzeitgedaechtnis exportiert',
  'roleConfig.deleteAllMemMeTitle': 'Gesamtes Kontogedaechtnis leeren',
  'roleConfig.deleteAllMemMePrompt': 'Dies kann nicht rueckgaengig gemacht werden. Geben Sie DELETE-ALL-MEMORY ein.',
  'roleConfig.deleteAllMemMeInputError': 'Geben Sie DELETE-ALL-MEMORY ein',
  'roleConfig.deleteAllMemMeSuccess': 'Langzeitgedaechtnis geleert',
  'roleConfig.memmeOperationFailed': 'Langzeitgedaechtnis ist voruebergehend nicht verfuegbar',
  ...
  'childSafety.subtitle': 'Daily chat review shows parents only risks that need attention.',
  ...
  'childSafety.privacyNote': 'Reports contain no full quotes. Text expires automatically; reports are kept for 90 days by default.',
  ...
  'childSafety.reportsHint': 'Risk summaries and parent guidance only',
  'childSafety.noReports': 'Reports appear after this feature is enabled',
