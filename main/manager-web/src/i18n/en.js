export default {
  ...
  'roleConfig.memmeDataHint': 'Manage account-wide memory; filtered text only',
  'roleConfig.exportMemMeData': 'Export Account Memory',
  'roleConfig.deleteAllMemMeData': 'Clear Account Memory',
  'roleConfig.exportMemMeSuccess': 'Long-term memory exported',
  'roleConfig.deleteAllMemMeTitle': 'Clear All Account Long-Term Memory',
  'roleConfig.deleteAllMemMePrompt': 'This cannot be undone. Enter DELETE-ALL-MEMORY to continue.',
  'roleConfig.deleteAllMemMeInputError': 'Enter DELETE-ALL-MEMORY',
  'roleConfig.deleteAllMemMeSuccess': 'Long-term memory cleared',
  'roleConfig.memmeOperationFailed': 'Long-term memory service is temporarily unavailable',
  ...
  'agentSnapshot.model.Memory_memme': 'MemMe local long-term memory',
  ...
  'header.childSafety': 'Parent Safety',
  'childSafety.title': 'Parent Safety Center',
  'childSafety.subtitle': 'Review daily chats and show parents only the risks that need attention.',
  'childSafety.privacyPill': 'Text only · No audio',
  'childSafety.unread': 'Unread alerts',
  'childSafety.todayEvents': 'Events today',
  'childSafety.latestLevel': 'Latest report risk',
  'childSafety.settingsTitle': 'Daily review settings',
  'childSafety.settingsHint': 'Enable separately for each agent',
  'childSafety.agent': 'Agent',
  'childSafety.enable': 'Enable daily safety review',
  'childSafety.textOnlyHint': 'Only text is reported; audio is never uploaded',
  'childSafety.reviewTime': 'Daily review time',
  'childSafety.chatRetention': 'Chat text retention',
  'childSafety.days': '{count} days',
  'childSafety.privacyNote': 'Reports do not show full quotes. Chat text expires automatically; reports are kept for 90 days by default.',
  'childSafety.reviewNow': 'Review now',
  'childSafety.save': 'Save settings',
  'childSafety.saved': 'Safety review settings saved',
  'childSafety.reviewComplete': 'Review complete',
  'childSafety.urgentTitle': 'Immediate safety events',
  'childSafety.urgentHint': 'Delivered by local rules without waiting for the daily report',
  'childSafety.noEvents': 'No immediate safety events',
  'childSafety.reportsTitle': 'Daily safety reports',
  'childSafety.reportsHint': 'Risk summaries and parent guidance only; no full child quotes',
  'childSafety.noReports': 'A report will be created after this feature is enabled',
  'childSafety.messageCount': '{count} messages reviewed',
  'childSafety.unknownAgent': 'Unknown agent',
  'childSafety.level.NONE': 'No risk',
  'childSafety.level.LOW': 'Low',
  'childSafety.level.MEDIUM': 'Medium',
  'childSafety.level.HIGH': 'High',
  'childSafety.level.CRITICAL': 'Critical',
  'childSafety.level.UNKNOWN': 'Needs review',
  'childSafety.category.self_harm': 'Self-harm risk',
  'childSafety.category.immediate_danger': 'Immediate danger',
  'childSafety.category.abuse_or_bullying': 'Possible abuse or severe bullying',
  'childSafety.category.dangerous_request': 'Dangerous request',
  'childSafety.category.privacy': 'Private information',
  'childSafety.category.parent_only_action': 'Parent-only action',
  'childSafety.category.bullying': 'Bullying',
  'childSafety.category.violence': 'Violence risk',
  'childSafety.category.adult_content': 'Age-inappropriate content',
  'childSafety.category.medical': 'Medicine or health risk',
  'childSafety.category.emotional_distress': 'Emotional distress',
  'childSafety.category.dependency': 'Dependency risk',
  'childSafety.category.other': 'Other concern',
