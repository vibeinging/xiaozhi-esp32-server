export default {
  ...
  'agentSnapshot.model.Memory_memme': 'MemMe本地長期記憶',
  ...
  'roleConfig.memmeDataHint': '管理本帳號的長期記憶；只儲存過濾後的文字',
  'roleConfig.exportMemMeData': '匯出本帳號記憶',
  'roleConfig.deleteAllMemMeData': '清空本帳號記憶',
  'roleConfig.exportMemMeSuccess': '長期記憶已匯出',
  'roleConfig.deleteAllMemMeTitle': '清空本帳號全部長期記憶',
  'roleConfig.deleteAllMemMePrompt': '此操作無法復原。請輸入 DELETE-ALL-MEMORY 後確認。',
  'roleConfig.deleteAllMemMeInputError': '請輸入 DELETE-ALL-MEMORY',
  'roleConfig.deleteAllMemMeSuccess': '長期記憶已清空',
  'roleConfig.memmeOperationFailed': '長期記憶服務暫時無法使用',
  ...
  'header.childSafety': '家長安全',
  'childSafety.title': '家長安全中心',
  'childSafety.subtitle': '每天複查孩子與小布的聊天，只把需要關注的風險告訴家長。',
  'childSafety.privacyPill': '只存文字 · 不存語音',
  'childSafety.unread': '未讀提醒',
  'childSafety.todayEvents': '今日即時事件',
  'childSafety.latestLevel': '最近日報風險',
  'childSafety.settingsTitle': '每日複查設定',
  'childSafety.settingsHint': '按每個智能體單獨開啟',
  'childSafety.agent': '智能體',
  'childSafety.enable': '開啟每日安全複查',
  'childSafety.textOnlyHint': '開啟後只上報文字，不上傳語音',
  'childSafety.reviewTime': '每天複查時間',
  'childSafety.chatRetention': '聊天文字保留',
  'childSafety.days': '{count} 天',
  'childSafety.privacyNote': '風險日報不展示完整聊天原話。文字到期自動刪除，安全報告預設保留90天。',
  'childSafety.reviewNow': '立即複查',
  'childSafety.save': '儲存設定',
  'childSafety.saved': '安全複查設定已儲存',
  'childSafety.reviewComplete': '複查完成',
  'childSafety.urgentTitle': '即時安全事件',
  'childSafety.urgentHint': '設備本地規則識別後立即送達，不等待日報',
  'childSafety.noEvents': '目前沒有即時安全事件',
  'childSafety.reportsTitle': '每日安全日報',
  'childSafety.reportsHint': '只顯示風險摘要和家長建議，不顯示孩子完整原話',
  'childSafety.noReports': '開啟後會在每天設定時間生成日報',
  'childSafety.messageCount': '複查 {count} 條訊息',
  'childSafety.unknownAgent': '未知智能體',
  'childSafety.level.NONE': '無風險',
  'childSafety.level.LOW': '低風險',
  'childSafety.level.MEDIUM': '中風險',
  'childSafety.level.HIGH': '高風險',
  'childSafety.level.CRITICAL': '緊急',
  'childSafety.level.UNKNOWN': '需人工確認',
  'childSafety.category.self_harm': '自傷或輕生風險',
  'childSafety.category.immediate_danger': '正在發生的危險',
  'childSafety.category.abuse_or_bullying': '疑似侵害或嚴重欺凌',
  'childSafety.category.dangerous_request': '危險行為請求',
  'childSafety.category.privacy': '隱私資訊',
  'childSafety.category.parent_only_action': '需要家長操作',
  'childSafety.category.bullying': '同伴欺凌',
  'childSafety.category.violence': '暴力風險',
  'childSafety.category.adult_content': '不適齡內容',
  'childSafety.category.medical': '用藥或健康風險',
  'childSafety.category.emotional_distress': '明顯情緒困擾',
  'childSafety.category.dependency': '過度依賴風險',
  'childSafety.category.other': '其他需關注內容',
