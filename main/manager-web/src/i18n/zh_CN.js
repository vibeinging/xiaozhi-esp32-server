export default {
  ...
  'roleConfig.memmeDataHint': '管理本账号的长期记忆；只保存过滤后的文字',
  'roleConfig.exportMemMeData': '导出本账号记忆',
  'roleConfig.deleteAllMemMeData': '清空本账号记忆',
  'roleConfig.exportMemMeSuccess': '长期记忆已导出',
  'roleConfig.deleteAllMemMeTitle': '清空本账号全部长期记忆',
  'roleConfig.deleteAllMemMePrompt': '此操作不能撤销。请输入 DELETE-ALL-MEMORY 后确认。',
  'roleConfig.deleteAllMemMeInputError': '请输入 DELETE-ALL-MEMORY',
  'roleConfig.deleteAllMemMeSuccess': '长期记忆已清空',
  'roleConfig.memmeOperationFailed': '长期记忆服务暂时不可用',
  ...
  'header.childSafety': '家长安全',
  'childSafety.title': '家长安全中心',
  'childSafety.subtitle': '每天复查孩子与小布的聊天，只把需要关注的风险告诉家长。',
  'childSafety.privacyPill': '只存文字 · 不存语音',
  'childSafety.unread': '未读提醒',
  'childSafety.todayEvents': '今日即时事件',
  'childSafety.latestLevel': '最近日报风险',
  'childSafety.settingsTitle': '每日复查设置',
  'childSafety.settingsHint': '按每个智能体单独开启',
  'childSafety.agent': '智能体',
  'childSafety.enable': '开启每日安全复查',
  'childSafety.textOnlyHint': '开启后只上报文字，不上传音频',
  'childSafety.reviewTime': '每天复查时间',
  'childSafety.chatRetention': '聊天文字保留',
  'childSafety.days': '{count} 天',
  'childSafety.privacyNote': '风险日报不展示完整聊天原话。文字到期自动删除，安全报告默认保留90天。',
  'childSafety.reviewNow': '立即复查',
  'childSafety.save': '保存设置',
  'childSafety.saved': '安全复查设置已保存',
  'childSafety.reviewComplete': '复查完成',
  'childSafety.urgentTitle': '即时安全事件',
  'childSafety.urgentHint': '设备本地规则识别后立即送达，不等待日报',
  'childSafety.noEvents': '目前没有即时安全事件',
  'childSafety.reportsTitle': '每日安全日报',
  'childSafety.reportsHint': '只显示风险摘要和家长建议，不显示孩子完整原话',
  'childSafety.noReports': '开启后会在每天设定时间生成日报',
  'childSafety.messageCount': '复查 {count} 条消息',
  'childSafety.unknownAgent': '未知智能体',
  'childSafety.level.NONE': '无风险',
  'childSafety.level.LOW': '低风险',
  'childSafety.level.MEDIUM': '中风险',
  'childSafety.level.HIGH': '高风险',
  'childSafety.level.CRITICAL': '紧急',
  'childSafety.level.UNKNOWN': '需人工确认',
  'childSafety.category.self_harm': '自伤或轻生风险',
  'childSafety.category.immediate_danger': '正在发生的危险',
  'childSafety.category.abuse_or_bullying': '疑似侵害或严重欺凌',
  'childSafety.category.dangerous_request': '危险行为请求',
  'childSafety.category.privacy': '隐私信息',
  'childSafety.category.parent_only_action': '需要家长操作',
  'childSafety.category.bullying': '同伴欺凌',
  'childSafety.category.violence': '暴力风险',
  'childSafety.category.adult_content': '不适龄内容',
  'childSafety.category.medical': '用药或健康风险',
  'childSafety.category.emotional_distress': '明显情绪困扰',
  'childSafety.category.dependency': '过度依赖风险',
  'childSafety.category.other': '其他需关注内容',
