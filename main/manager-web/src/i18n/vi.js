export default {
  ...
  'roleConfig.memmeDataHint': 'Bo nho toan tai khoan; chi luu van ban da loc',
  'roleConfig.exportMemMeData': 'Xuat bo nho tai khoan',
  'roleConfig.deleteAllMemMeData': 'Xoa bo nho tai khoan',
  'roleConfig.exportMemMeSuccess': 'Da xuat bo nho dai han',
  'roleConfig.deleteAllMemMeTitle': 'Xoa tat ca bo nho tai khoan',
  'roleConfig.deleteAllMemMePrompt': 'Khong the hoan tac. Nhap DELETE-ALL-MEMORY de tiep tuc.',
  'roleConfig.deleteAllMemMeInputError': 'Nhap DELETE-ALL-MEMORY',
  'roleConfig.deleteAllMemMeSuccess': 'Da xoa bo nho dai han',
  'roleConfig.memmeOperationFailed': 'Dich vu bo nho tam thoi khong san sang',
